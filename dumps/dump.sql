...
SELECT pg_catalog.setval('enrolled_enrolled_id_seq', 5, true);
...
SELECT pg_catalog.setval('"lecturerRating_lr_id_seq"', 2, true);
...
SELECT pg_catalog.setval('lecturer_lecturer_id_seq', 7, true);
...
SELECT pg_catalog.setval('"moduleRating_mr_id_seq"', 2, true);
...
SELECT pg_catalog.setval('module_module_id_seq', 3, true);
...
SELECT pg_catalog.setval('usage_usage_id_seq', 4, true);
...
INSERT INTO enrolled VALUES (4, 2, 3);
INSERT INTO enrolled VALUES (5, 1, 3);
...
INSERT INTO lecturer VALUES (6, 'Donald Trump', 'Hell', 'bigly@gmail.com', '0217 637 8516');
INSERT INTO lecturer VALUES (7, 'Luke Skywalker', '129 Force Road, Tatooine', 'farmboy@tatooine.com', '0593 209 1023');
...
INSERT INTO lecturer_rating VALUES (2, 10, 'Jedi are the protectors of peace, and I deduce that this guy is one of the best!', 2, 7);
...
INSERT INTO module VALUES (3, 'Defining the Force', 100, 'FO3930');
...
INSERT INTO module_rating VALUES (2, 10, 'Amazing Jedi! The force is awesome', 3, 1);
...
INSERT INTO teaching_method VALUES (6, 'Sorcery', 10);
...
INSERT INTO usage VALUES (7, 6, 4);
